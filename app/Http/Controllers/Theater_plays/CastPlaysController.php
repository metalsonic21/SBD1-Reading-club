...
class CastPlaysController extends Controller
{
    ...
    $plays = DB::select(DB::raw("SELECT o.id,o.nom,o.resum,o.costo,to_char(o.durac,'HH:MI:SS') as duracion,o.estatus,o.id_local FROM sjl_obras o WHERE $id=(SELECT h.id_club FROM SJL_historicos_presentaciones h WHERE h.id_obra=o.id)"));
    return view('theater_plays.castplays',compact('plays'));
        //return $plays;
