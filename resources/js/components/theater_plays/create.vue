                                    ...
                                    <b-form @submit.prevent="add">
                                        <b-row>
                                            <b-col cols="6">
                                                ...
                                                <b-form-select v-model="editoriales" :options="editoriales" ></b-form-select>
                                                <div class="mt-3">Selected: <strong>{{ editoriales }}</strong></div>
                                            </b-col>
                                        </b-row>
                                        <b-row>
...
export default {
    ...
    created() {
        axios.get('/castplays/create')
            .then(res => {                
                this.editoriales = res.data.libros;
