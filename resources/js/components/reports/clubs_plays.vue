                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-log card-header-icon">
                            ...
                            <div class="row">
                                <div class="col-lg-10">
                                    <h4 class="card-title">Generar reporte para Obras: Presentaciones</h4>
                                </div>
                                <div class="col-lg-2">
                                    ...
                                    <b-form>
                                        <b-row>
                                            <b-col cols="6">
                                                ...
                                                <small class="ml-3">Seleccione una obra para generar el reporte de sus presentaciones</small>
                                            </b-col>
                                        </b-row>
                                        <b-row>
                                            <b-col cols="12">
...
export default {
    data() {
        return {
            ...
            perPage: 10,
            currentPage: 1,
            fields: ['seleccionado', 'obra', 'libro_base', 'resumen'],
            items: [],
            selected: [],
            filterOn: [],
            filter: null,
