                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-log card-header-icon">
                            ...
                            <div class="row">
                                <div class="col-lg-10">
                                    <h4 class="card-title">Generar reporte de presentaciones</h4>
                                </div>
                                <div class="col-lg-2">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <b-form>
                                        ...
                                        <p>Seleccione un club y las fechas limite para generar el reporte de presentaciones</p>
                                        <b-row>
                                            <b-col cols="6">
...
export default {
    ...
    created() {
        axios.get(`/presentation-reports`)
            .then(res => {
    ...
    methods: {
        ...
        generate() {
            ...
            axios.post(`/reportpresentations`, params)
                .then(res => {
                    window.location = `/presentation-reports/${params.id}/${params.fec_i}/${params.fec_f}`;
                }).catch(e => {
                    console.log(e);
                })
        },
