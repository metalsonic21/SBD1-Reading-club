                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-log card-header-icon">
                            ...
                            <div class="row">
                                <div class="col-lg-10">
                                    <h4 class="card-title">Generar reporte para libro</h4>
                                </div>
                                <div class="col-lg-2">
                                    ...
                                    <b-form>
                                        ...
                                        <b-row>
                                            <b-col cols="6">
                                                ...
                                                <small class="ml-3">Seleccione un libro para generar el reporte</small>
                                            </b-col>
                                        </b-row>
...
export default {
    ...
    created() {
        ...
        path=path+'/';
        var clubi =20;
        var clubf =path.indexOf("/", 20); ;
        this.club =parseInt(path.substring(clubi, clubf),10);
        axios.get(`/club-books-fill/${this.club}`)
            .then(res => {
    ...
    methods: {
        ...
        generate(){
            ...
            axios.post(`/reportbooks`, params)
                .then(res => {
                    //console.log(res.data);
                    window.location = `/books-reports/${params.libro}`;
                    //window.location = `/thirtypercent`;
                }).catch(e => {
                    console.log(e);
                })
        },
