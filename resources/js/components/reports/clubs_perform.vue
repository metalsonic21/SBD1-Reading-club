                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-log card-header-icon">
                            ...
                            <div class="row">
                                <div class="col-lg-10">
                                    <h4 class="card-title">Generar reporte para club: Presentaciones</h4>
                                </div>
                                <div class="col-lg-2">
                                    ...
                                    <b-form>
                                        <b-row>
                                            <b-col cols="6">
                                                ...
                                                <small class="ml-3">Seleccione un club para generar el reporte de sus presentaciones</small>
                                            </b-col>
                                        </b-row>
                                        <b-row>
                                            <b-col cols="12">
