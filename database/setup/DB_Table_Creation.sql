...
ALTER TABLE SJL_historicos_presentaciones ADD CONSTRAINT obras_local_fk FOREIGN KEY(id_local) REFERENCES SJL_locales_eventos(id) ON DELETE CASCADE ON UPDATE CASCADE;
